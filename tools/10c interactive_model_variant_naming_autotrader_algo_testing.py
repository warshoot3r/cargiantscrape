...
while True:
    ...
    series_name = naming.translate_modelname_to_autotrader(car_make=car_make, input_string=car_model)
    naming.translate_modelvariant_to_autotrader(car_make=car_make, car_model=series_name, input_string=car_model)
